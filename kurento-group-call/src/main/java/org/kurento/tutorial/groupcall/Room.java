...
public class Room implements Closeable {
    ...
    public Room(String ARoomName, MediaPipeline AMediaPipeLine, RepositoryClient ARepositoryClient) {
        this.name = ARoomName;
        this.pipeline = AMediaPipeLine;
        this.repositoryClient = ARepositoryClient;
        log.info("ROOM {} has been created", ARoomName);
    }
    ...
    public UserSession join(String userName, WebSocketSession session) throws IOException {
        ...
        final UserSession participant = new UserSession(userName, this.name, session, this.pipeline, this.repositoryClient);
